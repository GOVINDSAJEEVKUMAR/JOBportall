...
export default function Home(){
  ...
  return (
    <div className="App font-sans">
      ...
      {/* Hero Section */}
      <section
  className="bg-blue-50 text-center py-16 flex items-center justify-center bg-cover bg-center"
  style={{
...
>
      <div className="container text-left text-blue-800 pl-10">
        <h1 className="text-4xl font-bold ">Your Out of House HR</h1>
        <p className="text-lg mt-4">Wherever you are, whenever you need!</p>
        <div className="mt-8">
          <button className="bg-blue-700 text-white px-8 py-3 rounded-md">
            View Our Services
          </button>
          <button className="ml-4 bg-white text-blue-700 border border-blue-700 px-8 py-3 rounded-md">
            Join Us
          </button>
        </div>
      </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto">
          ...
          <form className="mt-8 max-w-lg mx-auto">
            ...
            <button className="bg-blue-700 text-white px-8 py-3 rounded-md">Send Message</button>
          </form>
        </div>
      </section>
