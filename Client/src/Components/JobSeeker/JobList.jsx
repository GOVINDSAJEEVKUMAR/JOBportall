...
const DataFetchingComponent = () => {
  ...
  const filterData = () => {
    const filtered = data.filter(item => (
      ...
      (filter.type === '' || item.type?.toLowerCase() === filter.type.toLowerCase()) &&
          ...
          <div className="mb-2">
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                onChange={(e) =>
                  setFilter(prev => ({ ...prev, salary: [Number(e.target.value), prev.salary[1]] }))
                }
              ...
              <input
                ...
                onChange={(e) =>
                  setFilter(prev => ({ ...prev, salary: [prev.salary[0], Number(e.target.value)] }))
                }
                className="p-1 border rounded w-1/2"
              />
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {filteredData.map((item) => (
                <div key={item._id} className="border p-4 rounded-lg shadow-md bg-white transition-transform transform hover:bg-slate-100">
                  ...
                  <p className="text-xl mb-2">Company: {item.company}</p>
